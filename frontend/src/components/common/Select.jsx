    ...
    <div className="w-full space-y-1.5">
      ...
      <div className="relative rounded-lg shadow-xs">
        <select
          ref={ref}
          id={selectId}
          className={`block w-full text-sm rounded-lg border bg-white dark:bg-slate-900 px-3 py-2 text-slate-900 dark:text-slate-100 transition-colors focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 disabled:bg-slate-50 dark:disabled:bg-slate-800 disabled:text-slate-500 dark:disabled:text-slate-400 disabled:cursor-not-allowed ${
            error
