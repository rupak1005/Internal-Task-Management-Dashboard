      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full text-sm rounded-xl border border-slate-300/90 bg-slate-50/60 pl-10 pr-10 py-2.5 text-slate-900 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-inner/10"
          />
          {searchTerm && (
            <button
        ...
        <div className="w-full md:w-44">
          <select
            ...
            className="w-full text-sm rounded-xl border border-slate-300/90 bg-white px-3 py-2.5 text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium cursor-pointer shadow-sm"
          >
      ...
      {hasActiveFilters && (
        <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-slate-100 text-xs">
          <div className="flex flex-wrap items-center gap-1.5 text-slate-500">
            ...
            {filters.search && (
              <span className="px-2 py-0.5 rounded-md bg-blue-50 text-blue-700 font-medium border border-blue-200">
                "{filters.search}"
              </span>
            )}
            {filters.status && (
            ...
            {filters.priority && (
              <span className="px-2 py-0.5 rounded-md bg-amber-50 text-amber-700 font-medium border border-amber-200">
                {filters.priority}
              </span>
            )}
            {filters.assignee && (
          ...
          <button
            onClick={onReset}
            className="flex items-center gap-1 text-slate-500 hover:text-slate-800 font-medium hover:underline transition-colors cursor-pointer"
          >
